...
def get_args():
    ...
    parser.add_argument("--img-dir", type=str, required=True, help="Path to images directory")
...
def sweep_thresholds(val_probs, val_labels):
    ...
    optimal_thresholds = np.zeros(49)
...
def evaluate(args):
    ...
    test_dataset = RFMiD2Dataset(args.test_csv, args.img_dir, transform=get_val_transforms())
    ...
    print(f"Classes F1 > 0.5:  {classes_over_50} / 49")

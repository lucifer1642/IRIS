...
# The EXACT 49 classes of RFMiD 2.0. Must match rfmid_data_analysis.py exactly.
CLASS_NAMES = [
...
class RFMiD2Dataset(Dataset):
    def __init__(self, csv_file, img_dir, transform=None):
        ...
        if missing_cols:
            raise ValueError(f"CSV is missing required 49 disease columns: {missing_cols}")
    ...
    def __getitem__(self, idx):
        ...
        # Extract the 49 labels securely using predefined order
